    ...
    <section id="contact" className="min-h-screen py-20 px-6 relative overflow-hidden cyber-grid bg-gray-200 dark:bg-black">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <h2
          ...
          className={`text-4xl sm:text-5xl md:text-6xl font-bold mb-6 sm:mb-8 text-center transition-all duration-1000 ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
        >
          <span className="neon-text">Get In Touch</span>
        </h2>

        <p className={`text-center text-gray-600 dark:text-gray-400 text-base sm:text-lg mb-12 sm:mb-16 max-w-2xl mx-auto px-4 transition-all duration-1000 delay-200 ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
        ...
        >
          {contacts.map((contact, index) => (
            <a
              ...
              className={`group relative transition-all duration-1000 ${cardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
            ...
            >
              ...
              <div className={`relative bg-gray-100 dark:bg-gray-900/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border-2 border-gray-300 dark:border-gray-800 group-hover:border-blue-500 transition-all duration-500 transform group-hover:scale-105 group-hover:-translate-y-2 ${contact.hoverColor} hover:shadow-2xl`}>
                ...
                <div className="flex justify-center mb-4 sm:mb-6">
                  <div className={`relative transition-all duration-500 ${hoveredCard === contact.id ? 'scale-110 rotate-12' : 'scale-100 rotate-0'
                    }`}>
